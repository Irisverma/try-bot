...
# ---------------------------
TOKENS = [
"8531275524:AAFzHKZRLnFiMmdS3axpliX5qro1XNLMkw8",
"8462281340:AAFCJ2mQM9R0wthl5ZCoUZhn3BL54QyoI84"
]

CHAT_ID = -1002935984211
OWNER_ID = 5983742861
SUDO_FILE = "sudo.json"
...
# ---------------------------
RAID_TEXTS = [
    "चुदाई", "उठक बैठक लगा", "तेरी माँ muzan चोदे 🩸", 
    "ओय कमजोर", "लंड चूस", "पिल्लै", "ᴛᴍᴋʙ ᴍᴇɪ ʙʟᴏᴏᴅ ᴅᴇᴍᴏɴ ᴀʀᴛ 🥶", "कमजोर टट्टा",
    "bhg mt", "tmkc mei winter arc 😊", "मदरचोद", "ro", "रंडी", "चुप tmr",
    "रंडिपुत्री", "चुदकड़", "कमजोर पिल्ले 🤮👞👞", "cvr kr", "cud ke bhg mt",
    "zenx की माँ मारेगी", "tbkc", "चल तेरी माँ की चुत", "ka cr7 बाप🗿🌙💯💯"
]
...
async def start_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("🪷 RAGE GOD Ultra Multi — Commands 🐼\nUse /help")

async def help_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    help_text = """
🪷 RAGE GOD Ultra Multi — Commands 🐼
...
async def run_all_bots():
    ...
    print(f"🎉 RAGE GOD Ultra Multi is running with {len(bots)} bots!")
...
if __name__ == '__main__':
    ...
    # Your existing loop to start Application.run_polling() goes here
